...
export default function HelpFeedback({ articleId }: HelpFeedbackProps) {
  ...
  const handleSubmit = () => {
    if (comment.trim()) {
      ...
      const existing = JSON.parse(localStorage.getItem('help-feedback-comments') || '[]')
      existing.push(feedbackData)
      localStorage.setItem('help-feedback-comments', JSON.stringify(existing))
